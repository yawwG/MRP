...
class INBImageDataset(ImageBaseDataset):
    def __init__(self, cfg, args, split="train", transform=None, img_type="Frontal"):
        ...
        self.df = self.df.loc[(self.df['split'] == split) & (self.df['pcr'] != -1) ]
    ...
    def __getitem__(self, index):
        ...
        x_idx1 = self.imgpath + mri_img_path + ".nii.gz"  # plato
        try:
        ...
        if self.cfg.mip:
            ...
            return x_, y, x_idx1, x_idx1, image_state1, image_state2, c_stage, morph, tumor_behavior, tumor_type, N, M, molecular, radiotherapie, chemotherapie, immunotherapie, hormon, location, lateral, clinical_size, multifocal, insitu, differentiation, T, ignore_clinicalsize, ignore_T, post_T, post_N, age, weight, sex, brac1, brac2, chek2, tq53, menarche, menopause, ignore_N, ignore_M, ignore_postT, ignore_postN, ignore_tumortype, ignore_age, ignore_weight, ignore_menarche
        else:
            return x1[0].half().float(), y, x_idx1, x_idx2, image_state1, image_state2, c_stage, morph, tumor_behavior, tumor_type, N, M, molecular, radiotherapie, chemotherapie, immunotherapie, hormon, location, lateral, clinical_size, multifocal, insitu, differentiation, T, ignore_clinicalsize, ignore_T, post_T, post_N, age, weight, sex, brac1, brac2, chek2, tq53, menarche, menopause, ignore_N, ignore_M, ignore_postT, ignore_postN, ignore_tumortype, ignore_age, ignore_weight, ignore_menarche
